...
rh = window.rh;
model = rh.model;
var defaultTopic = "SnagIt_Help_File/SnagIt_Capturing.htm";
...
rh.consts('HELP_ID', 'c2dbf530-fd86-48f9-bcba-b97521759a79' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "SnagIt");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "Indigo");
